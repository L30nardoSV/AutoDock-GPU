...
absolute_min_vdw = min(all_min_vdw); absolute_max_vdw = max(all_max_vdw)
absolute_min_el = min(all_min_el); absolute_max_el = max(all_max_el)
absolute_min_desol = min(all_min_desol); absolute_max_desol = max(all_max_desol)
